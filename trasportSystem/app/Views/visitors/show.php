...
<section class="section">
          <div class="section-header">
            <ul>
            <h1><i class="fa-solid fa-user-tie"></i> &nbsp;  Visitors</h1>
            </ul>
          </div>
                                    ...
                                    <table id="example" class="display table dataTable table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><?php echo $visitor['nic']?></td>
                                                <td><?php echo $visitor['name']?></td>
                                                <td><?php echo $visitor['address']?></td>
                                                <td><?php echo $visitor['phone']?></td>
                                                  <td><?php echo $visitor['date']?></td>
                                                    <td>
                                                        <a href="<?= base_url('visitor/edit/'.$visitor['id'])?>"  class="btn btn-primary"> <i class="fa fa-edit"></i>&nbsp; Edit</a>
                                                         <button type="button" value="<?= $visitor['id']; ?>"  class="confirm_del_visitor_btn btn btn-danger"> <i class="fa fa-trash"></i>&nbsp; Delete</button>
