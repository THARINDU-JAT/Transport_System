        ...
        <main>
         ...
         <?php
                                                     ...
                                                     <div class="col-md-4 mb-3">
                                                        ...
                                                        <input type="text" class="form-control <?php echo (isset($validation) && $validation->hasError('contact_no'))? 'is-invalid' : '';?>" id="contact_no" name="contact_no" value="<?php echo set_value('contact_no')?>">
           <?php
